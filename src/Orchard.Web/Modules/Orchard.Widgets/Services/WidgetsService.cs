...
namespace Orchard.Widgets.Services {
    ...
    public class WidgetsService : IWidgetsService {
        ...
        public bool HasDedicatedZones(ExtensionDescriptor theme, string layer) {
            ...
            IEnumerable<string> layers = string.IsNullOrEmpty(theme.Layers) ? Enumerable.Empty<string>() : theme.Layers.Split(new[] { ',' }, StringSplitOptions.RemoveEmptyEntries).Select(l => l.Trim());
        ...
        public IEnumerable<string> GetZones(ExtensionDescriptor theme,string layer) {
            if(theme == null) {
                return Enumerable.Empty<string>();
            }
