...
namespace Orchard.Mvc.ModelMetadataProviders {
    public class ModelMetadataProviderProxy : ModelMetadataProvider, IShim {
        ...
        public ModelMetadataProviderProxy(ModelMetadataProvider currentProvider) {
        ...
        private IModelMetadataProvider GetModelMetadataProvider() {
            ...
            if (workContext != null) {
                return workContext.Resolve<IModelMetadataProvider>();
            }
    ...
    class ModelMetadataProviderWrapper : IModelMetadataProvider {
        private readonly ModelMetadataProvider _metadataProvider;

        public ModelMetadataProviderWrapper(ModelMetadataProvider metadataProvider) {
